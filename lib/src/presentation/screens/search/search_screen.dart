                          ...
                          child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                    if (searchProvider.searchedMovies[index].url
                                        .contains('tvshows')) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                            iconSize: 35,
                            onPressed: searchProvider.pageNo > 1
                                ? () async {
                                    await context
                                        .read<SearchProvider>()
                                        .backPage();
                        ...
                        IconButton(
                            iconSize: 35,
                            onPressed: searchProvider.searchedMovies.isNotEmpty
                                ? () async {
                                    await context
                                        .read<SearchProvider>()
                                        .nextPage();
